...
class ASI_Bulk_Generation_DB {
    ...
    public static function init() {
        global $wpdb;
        self::$table_jobs  = $wpdb->prefix . 'asi_bulk_jobs';
        self::$table_posts = $wpdb->prefix . 'asi_bulk_posts';
    }
    ...
    public static function maybe_create_tables() {
        $installed_version = get_option( 'asi_bulk_db_version' );
    ...
    public static function drop_tables() {
        ...
        delete_option( 'asi_bulk_db_version' );
    }
