...
<tr valign="top">
    ...
    <td>
        <input id="workers-account-id" type="text" name="ASI_plugin_banks_settings[workers_ai][account_id]" class="form-control" value="<?php echo esc_attr( $account_id ); ?>" />
...
<tr valign="top">
    ...
    <td id="password-workers" class="password">
        <input id="workers-api-token" type="password" name="ASI_plugin_banks_settings[workers_ai][api_token]" class="form-control" value="<?php echo esc_attr( $api_token ); ?>" />
...
<tr valign="top">
    ...
    <td>
        <select id="workers-model" name="ASI_plugin_banks_settings[workers_ai][model]" class="form-control form-control-lg">
            <?php
            $models = array(
...
<tr valign="top">
    ...
    <td>
        <input id="workers-steps" type="number" min="1" max="8" name="ASI_plugin_banks_settings[workers_ai][steps]" class="form-control" value="<?php echo esc_attr( $selected_steps ); ?>" />
...
<tr valign="top">
    ...
    <td>
        <textarea id="workers-negative" name="ASI_plugin_banks_settings[workers_ai][negative_prompt]" class="form-control" rows="3"><?php echo esc_textarea( $negative_prompt ); ?></textarea>
