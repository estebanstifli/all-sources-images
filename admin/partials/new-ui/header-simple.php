							...
							<div class="row">
								<div class="col-md-12">
									...
									<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-2x nav-tabs-primary" role="tablist" style="margin-bottom: 0; border-bottom: none;">
										<li class="nav-item">
											<a class="nav-link <?php echo $active_tab === 'source' ? 'active' : ''; ?>" href="<?php echo esc_url( admin_url( 'admin.php?page=asi-new-settings&tab=source' ) ); ?>">
												<?php esc_html_e( 'Source', 'all-sources-images' ); ?>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link <?php echo $active_tab === 'proxy' ? 'active' : ''; ?>" href="<?php echo esc_url( admin_url( 'admin.php?page=asi-new-settings&tab=proxy' ) ); ?>">
												<?php esc_html_e( 'Proxy', 'all-sources-images' ); ?>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link <?php echo $active_tab === 'others' ? 'active' : ''; ?>" href="<?php echo esc_url( admin_url( 'admin.php?page=asi-new-settings&tab=others' ) ); ?>">
